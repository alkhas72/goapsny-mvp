...
function WelcomeLogo() {
  // Тот же Accessible Icon, что в TelegramApp, местная копия: WelcomeLegend
  // живёт в публичной оболочке и не должен тянуть зависимость от Telegram-лица.
  return (
...
export function WelcomeLegend({ onContinue }: WelcomeLegendProps) {
  return (
    <div className="welcome-screen" role="dialog" aria-modal="true" aria-labelledby="welcome-title">
      <div className="splash-logo-wrap logo-size--splash" aria-hidden="true">
        <WelcomeLogo />
      </div>
